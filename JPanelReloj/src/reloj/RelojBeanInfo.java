...
public class RelojBeanInfo extends SimpleBeanInfo {
    ...
    private static final int PROPERTY_formato24h = 45;
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            ...
            properties[PROPERTY_alarma].setPropertyEditorClass ( reloj.RelojPropertyEditorSupport.class );
            ...
            properties[PROPERTY_formato24h] = new PropertyDescriptor ( "formato24h", reloj.Reloj.class, "isFormato24h", "setFormato24h" ); // NOI18N
            ...
            properties[PROPERTY_peer] = new PropertyDescriptor ( "peer", reloj.Reloj.class, "getPeer", null ); // NOI18N
    ...
    private static MethodDescriptor[] getMdescriptor(){
        ...
        try {
            ...
            methods[METHOD_addAlarmaListener7] = new MethodDescriptor(reloj.Reloj.class.getMethod("addAlarmaListener", new Class[] {reloj.AlarmaListener.class})); // NOI18N
